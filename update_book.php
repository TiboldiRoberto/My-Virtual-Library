<?php 
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
        ...
        if($result->num_rows != 0)
        {
            ...
            $query = "UPDATE books set title='$title',author='$author',language='$language',subject='$subject', year='$year', nr_pages='$nr_pages' WHERE id_book='$id_book'";

            mysqli_query($con, $query);

            echo "Book  with id $id_book has been updated";
            header("Location: form_update.php?success=11");
            die;
        }
        else {
